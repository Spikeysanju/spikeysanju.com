import { c as create_ssr_component, d as add_attribute, b as escape, h as subscribe, e as each, v as validate_component } from "../../../chunks/index3.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$unsubscribe_page();
  return `${$$result.head += `<!-- HEAD_svelte-1xuqe0w_START -->${$$result.title = `<title>Tools – Spikey Sanju</title>`, ""}<meta name="${"description"}" content="${"Tools I use on my day to day life."}"><!-- HEAD_svelte-1xuqe0w_END -->`, ""}

import { c as create_ssr_component, d as add_attribute, a as escape, k as compute_rest_props, e as each, v as validate_component, m as missing_component, j as getContext, l as createEventDispatcher, s as setContext } from "../../../chunks/ssr.js";
import { P as PUBLIC_WEBSITE_URL } from "../../../chunks/public.js";
import { E as Embedd } from "../../../chunks/Embedd.js";
...
const Link$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.raw === void 0 && $$bindings.raw && raw !== void 0)
    $$bindings.raw(raw);
  return `<a${add_attribute("href", href, 0)} class="font-medium text-blue-500 underline hover:cursor-pointer dark:text-blue-400">${escape(text)}</a>`;
});
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${$$result.head += `<!-- HEAD_svelte-6jzl71_START -->${$$result.title = `<title>About | Spikey Sanju</title>`, ""}<meta name="description"${add_attribute("content", data.description, 0)}><link rel="canonical" href="${escape(PUBLIC_WEBSITE_URL, true) + "/about"}"><meta name="robots" content="index, follow"><!-- HEAD_svelte-6jzl71_END -->`, ""} <section class="flex flex-col gap-6"><h1 class="text-3xl leading-tight tracking-tight sm:text-4xl sm:leading-snug lg:text-4xl lg:leading-tight" data-svelte-h="svelte-19hd4g9">Meet Spikey Sanju: Designer, Engineer, and ADHD-Inspired Innovator!</h1> <div class="whitespace-pre-line">${validate_component(SvelteMarkdown, "SvelteMarkdown").$$render(
    $$result,
    {
      ...
      renderers: { link: Link$1, html: Embedd }
    },
    {},
    {}
  )} </div></section>`;

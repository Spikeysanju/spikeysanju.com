...
const Icon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const className = "";
  const sizeMap = { large: 24, medium: 20, small: 16 };
  const icons = {
    day: {
      box: 24,
    ...
    night: {
      box: 24,
      svg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"></path><path d="M10 22h4"></path><path d="m2 2 20 20"></path><path d="M9 2.804A6 6 0 0 1 18 8a4.65 4.65 0 0 1-1.03 3"></path><path d="M8.91 14a4.61 4.61 0 0 0-1.41-2.5C6.23 10.23 6 9 6 8a6 6 0 0 1 .084-1"></path></svg>`
    },
    rightArrow: {
      box: 24,
  ...
  return ` <svg${add_attribute("class", className, 0)}${add_attribute("stroke", stroke, 0)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"${add_attribute("stroke-width", strokeWidth, 0)}${add_attribute("width", dimension, 0)}${add_attribute("height", dimension, 0)}><!-- HTML_TAG_START -->${icon.svg}<!-- HTML_TAG_END --></svg>`;
});
export {
  Icon as I
};

...
const BlogCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"flex w-full max-w-sm flex-col transition-all ease-linear hover:-rotate-3"}"><img${add_attribute("src", image, 0)}${add_attribute("alt", title, 0)} class="${"aspect-video"}">

...
const fetchProjectsMarkdownPosts = async () => {
  const allFiles = /* @__PURE__ */ Object.assign({ "/src/lib/data/projects/coop-the-app.md": () => import("./coop-the-app.js"), "/src/lib/data/projects/the-sample-project.md": () => import("./the-sample-project.js") });

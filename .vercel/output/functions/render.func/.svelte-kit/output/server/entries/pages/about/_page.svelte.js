import { c as create_ssr_component, a as escape, d as add_attribute } from "../../../chunks/index3.js";
...
<section class="${"h-screen"}"><h1 class="${"text-3xl leading-tight tracking-tight sm:text-4xl sm:leading-snug lg:text-4xl lg:leading-tight"}">When people ask me what I do, I tell them I&#39;m a designer and an engineer. Then they give me that

...
<section class="${"flex min-h-screen w-full flex-col items-center justify-center"}"><h1 class="${"w-full text-start tracking-tight"}">${escape(data.params.category)} Blogs.</h1>

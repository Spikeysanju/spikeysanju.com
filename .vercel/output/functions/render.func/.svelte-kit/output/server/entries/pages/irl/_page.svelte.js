import { c as create_ssr_component, f as add_attribute, a as escape, e as each, d as subscribe, v as validate_component } from "../../../chunks/index3.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$unsubscribe_page();
  return `${$$result.head += `<!-- HEAD_svelte-1xsc985_START -->${$$result.title = `<title>IRL – Spikey Sanju</title>`, ""}<meta name="${"description"}" content="${"People I want to meet IRL."}"><link rel="${"canonical"}" href="${escape(PUBLIC_WEBSITE_URL, true) + "/irl"}"><meta name="${"robots"}" content="${"index, follow"}"><!-- HEAD_svelte-1xsc985_END -->`, ""}

<section class="${"flex w-full flex-col items-center justify-center"}"><h1 class="${"flex w-full"}">People I want to Meet IRL.</h1>

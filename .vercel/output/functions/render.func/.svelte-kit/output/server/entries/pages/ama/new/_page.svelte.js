...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let question = "";
  return `${$$result.head += `<!-- HEAD_svelte-1gfa3s1_START -->${$$result.title = `<title>New Ama | Spikey Sanju</title>`, ""}<meta name="${"description"}" content="${"Ask me anything."}"><!-- HEAD_svelte-1gfa3s1_END -->`, ""}

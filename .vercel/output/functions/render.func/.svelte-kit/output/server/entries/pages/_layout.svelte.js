...
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `
<dialog class="${"inset-0 z-10 flex w-full max-w-2xl overflow-y-auto rounded-lg p-5 transition-all delay-75 ease-in-out backdrop:bg-black/50"}"${add_attribute("this", dialog, 0)}><div class="${"space-y-3"}">${slots.header ? slots.header({}) : ``}

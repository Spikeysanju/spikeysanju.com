...
<section class="${"flex min-h-screen w-full flex-col items-center justify-start"}"><h1 class="${"w-full text-start tracking-tight"}">${escape(data.params.category)} Books.</h1>

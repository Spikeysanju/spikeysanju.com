...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let question = "";
  return `<div class="${"flex w-full flex-col"}"><form action="${"?/create"}" method="${"post"}" class="${"flex w-full flex-col space-y-3"}"><label for="${"question"}" class="${"block text-sm font-medium text-gray-700"}">Question</label>

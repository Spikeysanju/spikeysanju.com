...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let image = "";
  let link = "";
  return `<div class="${"flex w-full flex-col"}"><form action="${"?/create"}" method="${"post"}" class="${"flex w-full flex-col space-y-3"}"><label for="${"name"}" class="${"block text-sm font-medium text-gray-700"}">Name</label>

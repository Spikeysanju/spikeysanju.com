...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${$$result.head += `<!-- HEAD_svelte-14o7prj_START -->${$$result.title = `<title>${escape(data.title)}</title>`, ""}<meta name="${"description"}"${add_attribute("content", data.description, 0)}><!-- HEAD_svelte-14o7prj_END -->`, ""}

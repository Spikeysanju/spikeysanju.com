import { c as create_ssr_component, e as each, d as add_attribute, v as validate_component } from "../../../chunks/index3.js";
import { B as BlogCard } from "../../../chunks/BlogCard.js";
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { data } = $$props;
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<section class="${"flex w-full flex-col items-center justify-center"}"><h1 class="${"flex w-full text-start tracking-tight"}">Projects.</h1>
